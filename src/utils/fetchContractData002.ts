...
export const fetchTransactions = async (
  ...
  const url = `https://api.basescan.org/api?module=logs&action=getLogs&address=$0xcE51BE974FBE7e642072cAdb87F3F63b80cD7c8E&fromBlock=0&toBlock=latest&apikey=${apiKey}`;
