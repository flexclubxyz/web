...
export const fetchTransactions = async (
  ...
  const url = `https://api.basescan.org/api?module=logs&action=getLogs&address=0x50E411Cd0219FF94e7683cbc379ffd907567F386&fromBlock=0&toBlock=latest&apikey=${apiKey}`;
