...
import Transactions004 from "@/components/Transactions004";
import ProgressBar from "../../components/ProgressBar";
import FAQ from "../../components/FAQ004";
...
export default function ClubPage() {
  ...
  return (
    <div className="max-w-lg mx-auto bg-gray-800 text-white rounded-lg shadow-md p-6 mt-4">
      ...
      {/* Club Information */}
      <div className="mt-6">
        <h2 className="text-xl font-semibold mb-2">Flexclub 004</h2>
        ...
        <div className="bg-gray-900 p-4 rounded-md flex items-center justify-between">
          <div>
            <p className="mb-1">
              ...
              <a
                href="https://www.base.org/name/temtsen"
                target="_blank"
      ...
      <div className="mt-6">
        ...
        <DonationDeposit
          contractAddress={contractAddress004}
          contractABI={contractABI004}
